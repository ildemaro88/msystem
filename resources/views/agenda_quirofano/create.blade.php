                                ...
                                <div class="container-fluid container-full">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text"  id="process_valide" ng-model='formData.process' name="process"  class="form-control" value="DIRECTORY" autocomplete="off" required/>
                                            <span style="color:red" ng-show="formCitaSend.process_valide.$dirty && formCitaSend.process_valide.$invalid">
                                                <span ng-show="formCitaSend.process_valide.$dirty && formCitaSend.process_valide.$error.required">Debe Seleccionar un quirófano.</span>
                                            </span>
                                        </div>
