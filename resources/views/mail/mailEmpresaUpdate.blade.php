                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="textContent" align="left" valign="top">
                                                                    <h3 style="color: #ffffff; line-height: 100%; font-family: 'Baloo Bhaina', sans-serif; font-size: 35px; font-weight: normal; margin-bottom: 10px; margin-top: 5px;">Actualizaci&oacute;n de  Usuario</h3>
                                                                    <div style="height: 30px; background: #34495e;">
                                                                        <h4 style="text-align: left; font-weight: normal; font-family: Helvetica,Arial,sans-serif; font-size: 16px; margin-bottom: 10px; margin-left: 5px; color: white; line-height: 135%; margin-top: 10px; padding-top: 3px; font-style: italic;">Sistema Optamed</h4>
                                                                    </div>
                                                                    <div style="height: 3px; background: #7f8c8d; margin-bottom: 8px;">&nbsp;</div>
                                                                    <div style="text-align: left; font-family: 'Roboto',Arial,sans-serif; font-size: 15px; font-weigth:100; margin-bottom: 0; color: #ffffff; line-height: 135%;">Estimados,<br /> <b>{{$empresa->nombre}},</b> <br /> Su cuenta de usuario para el sistema de Optamed ha sido actualizada correctamente, a continuaci&oacute;n puede ver el detalle de la misma:</div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                                        ...
                                                                        <td class="flexibleContainerBox" align="left" valign="top">
                                                                            <table style="max-width: 100%;" border="0" width="210" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="textContent" align="left">
                                                                                            <h3 style="color: #5f5f5f; line-height: 125%; font-family: 'Roboto',sans-serif; font-size: 20px; font-weight: normal; margin-top: 0; margin-bottom: 3px; text-align: left;">Informaci&oacute;n de la cuenta:</h3>
                                                                                            <br>
                                                                                            <div style="text-align: left; font-family: Helvetica,Arial,sans-serif; font-size: 15px; margin-bottom: 0; color: #5f5f5f; line-height: 135%;"><strong>Usuario:</strong> {{ $empresa->correo}}<br /></div><br />
                                                                                            <div style="text-align: left; font-family: Helvetica,Arial,sans-serif; font-size: 15px; margin-bottom: 0; color: #5f5f5f; line-height: 135%;"><strong>Contrase&ntilde;a: </strong><br />
                                                                                            {{$empresa->ruc}}
                                                                                            </div>
                                                                                            <br>
