                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="textContent" align="left" valign="top">
                                                                    ...
                                                                    <div style="text-align: left; font-family: 'Roboto',Arial,sans-serif; font-size: 15px; font-weigth:100; margin-bottom: 0; color: #ffffff; line-height: 135%;">Estimados,<br /> <b>{{$empresa->nombre}},</b> <br /> Su cuenta de usuario para el sistema de Optamed ha sido creada correctamente, a continuaci&oacute;n puede ver el detalle de la misma:</div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
