  ...
  try{
    HORARIO_TRABAJO.forEach(function(currentValue, index, arr){
      ...
      switch(parseInt(currentValue.dow["0"])){
        ...
        $("#tardelunes").trigger( "click" );
        lunesT(1,currentValue.start_t,currentValue.end_t);
        ...
        $("#tardemartes").trigger( "click" );
        martesT(2,currentValue.start_t,currentValue.end_t);
        ...
        $("#tardemiercoles").trigger( "click" );
        miercolesT(3,currentValue.start_t,currentValue.end_t);
        ...
        $("#tardejueves").trigger( "click" );
        juevesT(4,currentValue.start_t,currentValue.end_t);
        ...
        $("#tardeviernes").trigger( "click" );
        viernesT(5,currentValue.start_t,currentValue.end_t);
        ...
        $("#tardesabado").trigger( "click" );
        sabadoT(6,currentValue.start_t,currentValue.end_t);
        break;
        case 7:
        ...
        $("#tardedomingo").trigger( "click" );
        domingoT(7,currentValue.start_t,currentValue.end_t);
