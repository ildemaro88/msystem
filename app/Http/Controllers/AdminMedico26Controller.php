<?php namespace App\Http\Controllers;
	...
	class AdminMedico26Controller extends \crocodicstudio\crudbooster\controllers\CBController {
  ...
  'name' => 'email',
  'type' => 'email',
  'validation' => 'required|min:3|max:255|email|unique:medico',
  'width' => 'col-sm-10',
);
			$this->form[] = array (
  'dataenum' => NULL,
  'datatable' => 'institucion,id',
  'style' => NULL,
  'help' => NULL,
